...
export default function MyOrderScreen({ navigation }) {
    ...
    return (
      ...
      >
        <View style={styles.orderHeader}>
          <View>
            <Text style={styles.orderId}>¡n hàng #{item.id}</Text>
        ...
        <View style={styles.orderFooter}>
          <Text style={styles.totalLabel}>TÕng cÙng:</Text>
  ...
  const EmptyComponent = () => (
    <View style={styles.emptyContainer}>
      ...
      <Text style={styles.emptyText}>Ch°a có ¡n hàng nào</Text>
      <TouchableOpacity 
        style={styles.shopNowButton}
        onPress={() => navigation.navigate("HomeScreen")}
      >
        <Text style={styles.shopNowText}>Mua s¯m ngay</Text>
      </TouchableOpacity>
    </View>
  );
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>¡n hàng cça tôi</Text>
        <View style={{ width: 24 }} />
      </View>
