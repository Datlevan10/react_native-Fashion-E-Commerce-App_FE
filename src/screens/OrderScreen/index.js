...
const OrderScreen = ({ navigation, route }) => {
    ...
    const loadCustomerData = async () => {
        try {
            const customerIdStored = await SecureStore.getItemAsync(
                "customer_id"
            );
    ...
    const checkPaymentStatus = async (orderId) => {
        try {
            setLoading(true);
            const statusResult = await ZaloPayService.queryPaymentStatus(
                orderId
            );
            ...
            <ScrollView style={styles.scrollView}>
                ...
                <View style={styles.section}>
                    ...
                    <View style={styles.inputContainer}>
                        ...
                        <TextInput
                            ...
                            onChangeText={(value) =>
                                handleInputChange("shipping_city", value)
                            }
                ...
                <View style={styles.section}>
                    ...
                    <TouchableOpacity
                        ...
                        onPress={() =>
                            handleInputChange("shipping_method", "standard")
                        }
                    >
                        ...
                        <View style={styles.shippingRight}>
                            <Text style={styles.shippingPrice}>
                                {new Intl.NumberFormat("vi-VN").format(25000)}{" "}
                                VND
                            </Text>
                            {orderData.shipping_method === "standard" && (
                                <Feather
                    ...
                    <TouchableOpacity
                        ...
                        onPress={() =>
                            handleInputChange("shipping_method", "express")
                        }
                    >
                        <View style={styles.shippingInfo}>
                            <MaterialIcons
                    ...
                    <TouchableOpacity
                        ...
                        onPress={() =>
                            handleInputChange("shipping_method", "overnight")
                        }
                    >
                        <View style={styles.shippingInfo}>
                            <MaterialIcons
                ...
                <View style={styles.section}>
                    ...
                    <TouchableOpacity
                        ...
                        onPress={() =>
                            handleInputChange("payment_method", "qr_code")
                        }
                    >
                        <AntDesign
                            name="qrcode"
                    ...
                    <TouchableOpacity
                        ...
                        onPress={() =>
                            handleInputChange("payment_method", "zalopay")
                        }
                    >
                        <FontAwesome5
                            name="mobile-alt"
            ...
            <View style={styles.bottomContainer}>
                ...
                >
                    <Text style={styles.placeOrderText}>
                        Đặt hàng - {formatPrice(totalAmount + shippingFee)}
                    </Text>
                </TouchableOpacity>
            </View>
        </SafeAreaView>
