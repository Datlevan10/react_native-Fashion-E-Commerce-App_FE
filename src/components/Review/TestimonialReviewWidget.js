...
const TestimonialReviewWidget = ({ reviews }) => {
        ...
        return (
            <View style={styles.container}>
                <Text style={styles.title}>
                    Khách hàng của chúng tôi rất yêu thích chúng tôi
                </Text>
                <Text style={styles.subtitle}>Chưa có đánh giá nào.</Text>
            </View>
        );
    }
    ...
    return (
        <View style={styles.container}>
            <Text style={styles.title}>Khách hàng yêu thích chúng tôi</Text>
            <Text style={styles.subtitle}>
                Phản hồi thực tế từ khách hàng thân thiết của chúng tôi
            </Text>
